...
type OrdersEDIForVoluntaryChainSMEsSDC struct {
	HeaderAndItem OrdersEDIForVoluntaryChainSMEsHeaderAndItem `json:"HeaderAndItem"`
}

type OrdersEDIForVoluntaryChainSMEsHeaderAndItem struct {
	Header OrdersEDIForVoluntaryChainSMEsHeader `json:"Header"`
