...
type OrdersEDIForSMEsSDC struct {
	HeaderAndItem OrdersEDIForSMEsHeaderAndItem `json:"HeaderAndItem"`
}

type OrdersEDIForSMEsHeaderAndItem struct {
	Header OrdersEDIForSMEsHeader `json:"Header"`
	Item   []OrdersEDIForSMEsItem `json:"Item"`
}
