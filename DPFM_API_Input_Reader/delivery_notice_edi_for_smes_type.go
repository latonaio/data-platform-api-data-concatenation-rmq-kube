...
type DeliveryNoticeEDIForSMEsSDC struct {
	...
	DataConcatenation   *DeliveryNoticeEDIForSMEsDataConcatenation `json:"DataConcatenation"`
...
type DeliveryNoticeEDIForSMEsDataConcatenation struct {
	Header DeliveryNoticeEDIForSMEsHeader `json:"DeliveryNoticeHeader"`
	Item   []DeliveryNoticeEDIForSMEsItem `json:"DeliveryNoticeItem"`
}
