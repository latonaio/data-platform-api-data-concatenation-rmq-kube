...
type OrdersEDIForSMEsSDC struct {
	...
	DataConcatenation   OrdersEDIForSMEsDataConcatenation `json:"DataConcatenation"`
...
type OrdersEDIForSMEsDataConcatenation struct {
	Header OrdersEDIForSMEsHeader `json:"OrdersHeader"`
	Item   []OrdersEDIForSMEsItem `json:"OrdersItem"`
}

type OrdersEDIForSMEsHeader struct {
...
type OrdersEDIForSMEsItem struct {
	ExchangedOrdersDocumentIdentifier                                      string   `json:"ExchangedOrdersDocumentIdentifier"`
